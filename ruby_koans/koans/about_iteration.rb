...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Answer: inject combines all elements of a collection by applying a binary operation,
    # starting with an initial value (the argument to inject) and accumulating the result.
  end
  ...
  #   # code to read 'file'
  #
  # Answer: The block form automatically closes the file when the block ends,
